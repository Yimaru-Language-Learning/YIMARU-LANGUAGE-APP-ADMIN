...
export const RESOURCE_TYPE_OPTIONS: { value: string; label: string }[] = [
  ...
  { value: "EXAM_PREP_CATALOG_COURSE", label: "Duolingo/IELTS course" },
  { value: "EXAM_PREP_UNIT", label: "Duolingo/IELTS unit" },
  { value: "EXAM_PREP_MODULE", label: "Duolingo/IELTS module" },
  { value: "EXAM_PREP_LESSON", label: "Duolingo/IELTS lesson" },
  { value: "EXAM_PREP_PRACTICE", label: "Duolingo/IELTS practice" },
