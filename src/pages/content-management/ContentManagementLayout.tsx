    ...
    <div className="mx-auto w-full min-w-0 max-w-7xl px-0 py-4 sm:px-4 sm:py-6 lg:px-6">
      <div className="mb-6 sm:mb-8">
        <div className="mb-6 flex items-center gap-3 sm:mb-8">
          <div className="h-9 w-1 shrink-0 rounded-full bg-gradient-to-b from-brand-500 to-brand-600" />
          <div className="min-w-0">
            <h1 className="text-xl font-bold tracking-tight text-grayScale-900 sm:text-2xl sm:text-[1.65rem]">
              Content Management
            </h1>
