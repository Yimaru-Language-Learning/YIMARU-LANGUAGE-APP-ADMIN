...
export const PROFILE_FILTER_LANGUAGE_GOALS = LANGUAGE_GOAL_OPTIONS
export const PROFILE_FILTER_FAVOURITE_TOPICS = FAVOURITE_TOPIC_OPTIONS
export const PROFILE_FILTER_KNOWLEDGE_LEVELS = KNOWLEDGE_LEVEL_OPTIONS
export const PROFILE_FILTER_ETHIOPIA_REGIONS = ETHIOPIA_REGION_OPTIONS
