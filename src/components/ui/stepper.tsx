        ...
        return (
          ...
          >
            ...
            {index < steps.length - 1 && (
              <div
                className="absolute top-4 h-[1.5px] bg-grayScale-200 dark:bg-grayScale-300 z-0"
            ...
            <div
              className={cn(
                ...
                isCurrent
                  ...
                  : "border-grayScale-100 dark:border-grayScale-300 bg-white dark:bg-grayScale-100 text-grayScale-400 dark:text-grayScale-500 font-medium",
              )}
            >
              {stepNumber}
            </div>
            ...
            <span
              className={cn(
                ...
                isCurrent ? "text-brand-500" : "text-grayScale-400 dark:text-grayScale-500 font-medium",
              )}
            >
              {step}
            </span>
